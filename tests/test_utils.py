...
class TestUtils(unittest.TestCase):
    ...
    def test_get_final_answer(self, mock_get_answer_similarity_score):
        ...
        mock_get_answer_similarity_score.side_effect = [0.8864094018936157, 0.6653278470039368, 0.7024734020233154]

        assert utils.get_final_answer(test_answer_candidates) == "early 1990s"
